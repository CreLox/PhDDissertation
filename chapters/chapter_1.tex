...
% sensitivity ~ responsiveness (releasing the block promptly once all attachment is secured?)
...
% Cooperativity example: avidity
% Taking a cue from different well-studied biological decision-making processes
% Other biological decision-making processes that deploy cooperativity?
% Just like effective collaborations between people in the society, positive cooperativity in biochemical processes can synergize reactions and amplify the output, which may be fundamental to the sensitivity of the SAC.
