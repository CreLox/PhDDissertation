...
% Committee
\committee{
Professor Ajit P. Joglekar, Chair \\
...
% \chair{Ajit P. Joglekar}

% Definition of any acronyms used.
\acronyms{
\acro{a.a.}{amino acid(s) (number)}
\acro{ABBA}{A-type cyclins, BUBR1, BUB1, and Acm1}
...
\acro{eSAC activator}{ectopic spindle assembly checkpoint activator}
...
\acro{MIM}{MAD2-interacting motif, which is also named ``MAD2-binding motif (MBM)'' or ``closure motif''}
\acro{mNG}{mNeonGreen}
...
\acro{RWD}{RING finger-containing proteins, WD repeat-containing proteins, and DEAD-like helicases}
