...
%    \Title{Quantitative and Mechanistic Studies on the Spindle Assembly Checkpoint in Human Cells Reveal the Origin of Its Sensitivity}
%    \Author{Chu Chen}
%    \Keywords{mitosis\sep signaling pathway\sep spindle assembly checkpoint}
%\end{filecontents*}
